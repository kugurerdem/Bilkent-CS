...
HD_PWD='/home/ugur/Desktop/lab_02/lab_02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log finalModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source finalModule.tcl -notrace
