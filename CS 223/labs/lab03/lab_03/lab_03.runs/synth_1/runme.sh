...
HD_PWD='/home/ugur/Desktop/lab_03/lab_03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finalModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finalModule.tcl
